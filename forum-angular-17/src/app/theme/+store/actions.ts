...
export const themeListThemesLoaded = createAction(
    `${themeListNamespace} Themes Loaded`,
    props<{ themeList: ITheme[] }>()
  );
  
  export const themeListPostsLoaded = createAction(
    `${themeListNamespace} Posts Loaded`,
